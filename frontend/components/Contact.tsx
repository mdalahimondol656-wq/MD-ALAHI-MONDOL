                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 flex flex-col gap-1">
                      <a href="tel:01770340226" className="text-cyan-400 hover:underline">01770 340 226</a>
                      <a href="tel:01518951529" className="text-cyan-400 hover:underline">0151 895 1529</a>
                    </dd>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 flex flex-col gap-1">
                      <a href="mailto:mondolmdalahe1880@gmail.com" className="text-cyan-400 hover:underline">mondolmdalahe1880@gmail.com</a>
                      <a href="mailto:dwlaha9@gmail.com" className="text-cyan-400 hover:underline">dwlaha9@gmail.com</a>
                    </dd>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-1">November 02, 1999</dd>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <dd className="mt-1">Bangladeshi</dd>
                  </div>
                </div>
              </dl>

              <div className="mt-6 flex gap-3">
                <a href="https://www.instagram.com/mdalahimondol" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 text-slate-400 transition-all hover:bg-cyan-500/10 hover:border-cyan-500/30 hover:text-cyan-400" aria-label="Instagram">
                  <Camera className="h-5 w-5" />
                </a>
                <a href="https://www.linkedin.com/in/md-alahi-914b13285" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 text-slate-400 transition-all hover:bg-cyan-500/10 hover:border-cyan-500/30 hover:text-cyan-400" aria-label="LinkedIn">
                  <ExternalLink className="h-5 w-5" />
                </a>
                <a href="https://github.com/mdalahimondol" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 text-slate-400 transition-all hover:bg-cyan-500/10 hover:border-cyan-500/30 hover:text-cyan-400" aria-label="GitHub">
                  <GitBranch className="h-5 w-5" />
                </a>
                <a href="mailto:mondolmdalahe1880@gmail.com" className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 border border-white/10 text-slate-400 transition-all hover:bg-cyan-500/10 hover:border-cyan-500/30 hover:text-cyan-400" aria-label="Email">
            ...
            <form onSubmit={handleSubmit} className="glass-card p-6 sm:p-8 space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none transition-all placeholder:text-slate-600 focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none transition-all placeholder:text-slate-600 focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20"
